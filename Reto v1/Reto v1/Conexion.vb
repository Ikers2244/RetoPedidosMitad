...
Public Class Conexion
    ...
    Public MiDataAdapter, MiDataAdapter2, MiDataAdapter3, da1, da2, da3 As SqlDataAdapter
    Public MiDataSet, MiDataSet2, MiDataSet3, MiDataSet4 As DataSet
    ...
    Public Sub Conectar()
        Try
            ...
            da2 = New SqlDataAdapter("Select Nombre, Precio From Articulos Where Eliminado= 'False' AND Tipo= 'Entrante'", MiConexion)
            da3 = New SqlDataAdapter("Select Nombre, Precio From Articulos Where Eliminado= 'False' AND Tipo= 'Principal'", MiConexion)
